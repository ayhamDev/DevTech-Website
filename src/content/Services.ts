    ...
    details: [
      {
        ...
        فريق الخبراء لدينا مكرس لتقديم المشورة لعملائنا ووضعهم في الاتجاه الصحيح لتحقيق أهدافهم.
       نحن ندرك أن كل موقف فريد من نوعه، ولهذا السبب نأخذ الوقت الكافي للاستماع إلى عملائنا وتقديم حلول مخصصة تلبي احتياجاتهم الخاصة، ومن خلال خدمة الاستشارة التي نقدمها، يمكنك أن تطمئن إلى أنك ستحصل على التوجيه والدعم الذي تحتاجه لتحقيق النجاح.
       `,
      },
    ],
  },
    ...
    details: [
      {
        ...
        text_ar: `نقدم لعملائنا الكرام أفضل مساعدة ممكنة في إنشاء حملة من شأنها رفع مستوى تواجدهم وعلامتهم التجارية عبر الإنترنت إلى آفاق جديدة.
        تم تصميم خدمة التسويق لدينا خصيصًا لمساعدة عملائنا على تحديد الفئة المستهدفة الصحيحة، وتمكينهم من تنمية علامتهم التجارية بطريقة تلقى صدى لدى جمهورهم.
        بفضل خبرتنا الواسعة وتجاربنا، يمكننا مساعدتك في تحقيق أهدافك التسويقية وتجاوز توقعاتك.
        `,
      },
      {
    ...
    details: [
      {
        ...
        text_ar: `هي خدمة مخصصة لمساعدة الشركات على إنشاء هوية بصرية قوية تلقى صدى لدى عملائها وتميزهم عن منافسيهم.
        تشمل خدمات التصميم تحديث الشعارات وإعادة تصميم مواقع الويب وإنشاء هويات جديدة للعلامة التجارية. 
       يقدم فريقنا من المصممين ذوي الخبرة حلولاً مخصصة عالية الجودة تلبي الاحتياجات الفريدة لكل عميل.
       `,
      },
    ],
  },
    ...
    details: [
      {
        ...
        يتقن فريقنا من المطورين ذوي الخبرة العديد من لغات وأطر البرمجة، مع برنامج معمل يسمح لعملائنا بتتبع التقدم المحرز بسهولة.
